...
const UserList = () => {
  ...
  if (window.confirm("Are you sure you want to delete this user?")) {
    ...
    setUsers(updated);
    localStorage.setItem("users", JSON.stringify(updated)); // ✅ simpan lagi ke localStorage
  }
};
      ...
      <div id="Content" className="flex flex-col flex-1 p-6 pt-0">
        ...
        <main className="flex flex-col gap-6 flex-1">
          ...
          >
            ...
            {/* User List */}
            <div id="User-List" className="flex flex-col px-4 gap-5 flex-1">
              ...
              {users.length > 0 ? (
                      ...
                      <div className="card flex items-center justify-between gap-6">
                        ...
                        <div className="flex items-center gap-3 w-[226px] shrink-0">
                          ...
                          <div className="flex flex-col gap-1">
                            <p className="font-medium text-sm text-monday-gray">User Role:</p>
                        ...
                        <button
                          ...
                          className="btn btn-danger min-w-[130px] font-semibold"
                        >
                          Delete
                        </button>
                      </div>
                ...
                <div
                  id="Empty-State"
                  className="flex flex-col flex-1 items-center justify-center rounded-[20px] border-dashed border-2 border-monday-gray gap-6 p-6"
                >
                  <img
