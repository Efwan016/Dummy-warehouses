...
const StepTwo = ({ handleNextStep, handlePrevStep, handleOpenModal }) => {
    ...
    return (
        ...
        >
            ...
            <div
                id="Product-List"
                className="flex flex-col px-4 gap-5 flex-1 max-h-[70vh] overflow-y-auto"
            >
                                ...
                                <div className="card flex items-center justify-between gap-6">
                                    ...
                                    <div className="flex items-center gap-4">
                                        <button
                                            ...
                                            className="btn bg-monday-red/10 rounded-2xl text-monday-red w-[146px] font-semibold"
                                        >
                                            <img
