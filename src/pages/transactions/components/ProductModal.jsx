...
const useMerchants = () => {
  ...
  useEffect(() => {
    ...
    // untuk demo, ambil merchant pertama
    setData(merchants[0] || { products: [] });
  }, []);
...
const ProductModal = ({ isOpen, onClose }) => {
  ...
  // load cart dari localStorage sekali
  useEffect(() => {
      ...
      <div className="relative flex flex-col flex-1 w-full max-w-[1200px] h-full max-h-[752px] shrink-0 rounded-3xl p-[18px] gap-5 bg-white">
        ...
        <div className="modal-content flex flex-1 overflow-y-auto overscroll-contain hide-scrollbar">
                  ...
                  <div className="flex items-center justify-between gap-6">
                    ...
                    <div className="flex items-center rounded-2xl p-4 gap-3 bg-monday-blue/10 text-monday-blue">
                      <button
                        ...
                        type="button"
                        className="minus flex size-6 shrink-0"
                      >
                        <img
                      ...
                      <button
                        onClick={() => updateQuantity(product.id, 1)}
                        type="button"
                        className="plus flex size-6 shrink-0"
                      >
                        <img
          ...
          <div
            id="Empty-State"
            className={`${
              merchant?.products?.length ? "hidden" : "flex"
            } flex-col flex-1 items-center justify-center rounded-[20px] border-dashed border-2 border-monday-gray gap-6`}
          >
            <img
