...
const TransactionList = () => {
    const { transactions } = useTransactions(); // ambil dari localStorage
    const { merchants, getMerchant } = useMerchants(); // dummy merchant localStorage
            ...
            <div id="main-container" className="flex flex-1">
                ...
                <div id="Content" className="flex flex-col flex-1 p-6 pt-0">
                    ...
                    <main className="flex flex-col gap-6 flex-1">
                        {/* Warehouse Info */}
                        <section className="flex items-center justify-between rounded-3xl p-[18px] gap-3 bg-white">
                                            ...
                                            <div className="flex flex-col px-4 gap-5 py-5">
                                                ...
                                                >
                                                    ...
                                                    <img
                                                        ...
                                                        className={`size-6 flex shrink-0 transition-300 ${openTransactionIds.includes(tx.id)
                                                                ? "rotate-180"
                                                                : ""
                                                            }`}
                                                        alt="icon"
