...
import { useTransactions } from "../../hooks/useTransactions"; // localStorage hook
      ...
      <div id="main-container" className="flex flex-1">
        ...
        <div id="Content" className="flex flex-col flex-1 p-6 pt-0">
          ...
          <main className="flex flex-col gap-6 flex-1">
            ...
            {step === 1 && (
              <StepOne handleNextStep={() => setStep(2)} />
            )}
            ...
            {step === 3 && (
              <StepThree
                handlePrevStep={() => setStep(2)}
                handleSubmit={(transactionData) => {
                  addTransaction(transactionData); // simpan ke localStorage
                  setStep(1); // reset ke awal
                }}
              />
            )}
          </main>
